...
public class SlowSpikes : MonoBehaviour
{
    ...
    public float fallSpeed = 0.5f; // Adjust this value to control fall speed (lower value means slower fall)
    ...
    public void StartFalling()
    {
        ...
        {
            hasFallen = true;
            rb.gravityScale = fallSpeed; // Enable gravity with a lower scale to make the object fall slowly
        }
    }
